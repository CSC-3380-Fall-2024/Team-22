...
public partial class Boss : CharacterBody2D
{
    ...
    {	
		...
		if (health <= 20)
		{
			GlobalPosition = new Vector2(Position.X, Position.Y + 50);
		}
		else if (health <= 40)
		{
			GlobalPosition = new Vector2(Position.X + 100, Position.Y);
		}
		else if (health <= 60)
		{
			GlobalPosition = new Vector2(Position.X, Position.Y - 50);
		...
		{
			GlobalPosition = new Vector2(Position.X - 50, Position.Y);
		}
    }
